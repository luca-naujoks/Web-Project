     ...
     <div className='m-5'>
      ...
      <div className="flex justify-between p-2.5">
          <Link href="/">
            ...
            <button id="login" className="bg-[transparent] border-none">
              <img src="../assets/Navigation/login.png" alt="Login" className="h-10 hover:scale-125 transition duration-700 ease-in-out"/>
            </button>
      </div>

      <div id="login_modal" className="bg-gray-800 m-auto w-[30%] rounded-2xl border-gray-900 border-8 p-3 block">
