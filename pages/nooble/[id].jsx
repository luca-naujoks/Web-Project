...
export default function Post({ postData }) {
  return (
    <div>
      ...
      <main className="">
        <div className="py-5 bg-[#161b22] rounded-md ml-[2.5%] m-2 sm:w-auto lg:w-[50%] text-3xl p-10">
          <h2>{postData.title}</h2>
        </div>

        <div className="float-left bg-[#161b22] sm:w-auto lg:w-[50%] rounded-md p-10 text-xl text-gray-400 mt-2 mb-1 mr-2 ml-[2.5%]">
          <h3>Übersicht:</h3>
          {postData.info}
        </div>

        <div className="float-left bg-[#161b22] sm:w-[96%] lg:w-[50%] rounded-md p-10 text-xl text-white ml-[2.5%]">
          <h3>Links:</h3>
